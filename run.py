...
if __name__ == "__main__":
    ...
    FOLD_IDX = 0
    WORKSPACE_DIR = 'Please type in your path for data and weight saving'
    DATA_DIR_PanNuke = f'{WORKSPACE_DIR}/data/pannuke_data/'
    DATA_DIR_Lizard = f'{WORKSPACE_DIR}/data/lizard_data/'
    SAVE_ROOT = 'exp_output/local/models/test/'
    image_size = 128
    ...
    def run_one_split_with_param_set(save_path, split_info, param_kwargs):
        ...
        def create_dataset_PanNuke(
            ...
            img_path = f'{DATA_DIR_PanNuke}/images.npy'
            ann_path = f'{DATA_DIR_PanNuke}/labels.npy'
        ...
        def create_dataset_Lizard(
                run_mode=None, subset_name=None, setup_augmentor=None):
            target_gen_func = getattr(
                importlib.import_module('models.hovernet.targets'),
                'gen_targets'
            )
            img_path = f'{DATA_DIR_Lizard}/images_del_few.npy'
            ann_path = f'{DATA_DIR_Lizard}/labels_del_few.npy'
            indices = split_info[subset_name]
            return FileLoader(
                        img_path,
                        ann_path,
        ...
        def create_dataset_Lizard_few(
                run_mode=None, subset_name=None, setup_augmentor=None):
            target_gen_func = getattr(
                importlib.import_module('models.hovernet.targets'),
                'gen_targets'
            )
            img_path = f'{DATA_DIR_Lizard}/images_few_30shot.npy'
            ann_path = f'{DATA_DIR_Lizard}/labels_few_30shot.npy'
            indices = split_info[subset_name]
            return FileLoader(
                        img_path,
                        ann_path,
        ...
        run_kwargs = {
            ...
            'create_dataset_PanNuke': create_dataset_PanNuke,
            'create_dataset_Lizard': create_dataset_Lizard,
            'create_dataset_Lizard_few': create_dataset_Lizard_few, 
